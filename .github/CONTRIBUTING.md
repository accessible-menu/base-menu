# Contributing to accessible-menu projects
...
## Report bugs using Github's [issues](https://github.com/accessible-menu/base-menu/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/accessible-menu/base-menu/issues/new).
